...
function ans = rkf (t0,y0,h,upper_bound)
  ...
  while t < upper_bound
    ...
    k1=h*f_d(t,y);
    k2 = h*f_d(t+h/4, y+k1/4);
    k3 = h*f_d(t+3*h/8, y+3*k1/32+9*k2/32);
    k4 = h*f_d(t+12*h/13, y+1932*k1/2197-7200*k2/2197+7296*k3/2197);
    k5 = h*f_d(t+h, y+439*k1/216-8*k2+3680*k3/513-845*k4/4104);
    k6 = h*f_d(t+h/2, y-8*k1/27+2*k2-3544*k3/2565+1859*k4/4104-11*k5/40);
